...
\begin{frame}{Backside Imaging}
    \begin{figure}[t]
        \subfigure[]{
            \includegraphics[trim=0mm 0mm 0mm 0mm,clip,width=0.5in]{layout.png}
            \label{layout}
        }~
        \subfigure[]{
            \includegraphics[trim=8mm 8mm 8mm 8mm,clip,width=0.65in]{mod/Free.pdf}
...
\begin{figure}[t]
    \centering
    \subfigure[]{
        \includegraphics[trim=8mm 8mm 8mm 8mm,clip,width=0.5in]{mod/In.pdf}
        \label{multiple_gates_with_changes_to_filler_cells}
    }~
    \subfigure[]{
        \includegraphics[trim=8mm 8mm 8mm 8mm,clip,width=0.5in]{shi/In.pdf}
        \label{multiple_gates_with_shifts_to_filler_cells}
    }~
    \subfigure[]{
        \includegraphics[trim=8mm 8mm 8mm 8mm,clip,width=0.5in]{rep/In.pdf}
    ...
    \caption{\small{
        ...
        functional cells that constitute the HT.}}
...
\begin{figure}
    \includegraphics[width=0.8\columnwidth]{thresholdDecision.pdf}
...
\begin{figure}[t]
   ...
   \vspace{-0.2in}
    \caption{
        ...
        m$ region of the AEST100 hardware block with {\color{red}CDMA private
...
\begin{figure}
	\centering
    \includegraphics[width=0.75\textwidth]{snr.pdf}
    \label{fig:snr}
    \caption{
        {\color{red}Testbench AES and PIC Trojan Detection Rate under different
...
\begin{figure}[!t]
    \begin{center}
        \includegraphics[width=0.75\textwidth]{fillercells.pdf}
        \vspace{-0.2in}
...
\begin{table}
    ...
    %\resizebox{\textwidth}{!}{%
    \begin{center}
    \begin{tabular*}{2\columnwidth}{c c c c c c c}
...
PIC300 & 0.03617 & 0.2759 & 0.04196 & 0.4416 & 16 & 60 \\
    \end{tabular*}
    \caption{Power consumption (in $mW$) in various hardware blocks. The baseline designs of AES100, AES200 and AES1000 is the same, the inserted HTs are different. Similarly, the baseline design of PIC100, PIC200 and PIC300 are the same but the inserted HTs are different.}
    \vspace{-0.25in}
    \label{tab:power}
    %}
    \end{center}
